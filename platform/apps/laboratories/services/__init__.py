...
from apps.laboratories.services.laboratory_order import (
    cancel_laboratory_order,
    create_laboratory_order,
    update_laboratory_order,
)
from apps.laboratories.services.laboratory_result import (
...
from apps.laboratories.services.laboratory_test import (

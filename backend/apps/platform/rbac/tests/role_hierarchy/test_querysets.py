"""
Tests for the RoleHierarchy queryset.
"""
...
class RoleHierarchyQuerySetTestCase(
    TestCase,
):
    """
    Tests for RoleHierarchyQuerySet.
    """
    ...
    def test_should_return_active_role_hierarchies(
        ...
        """
        active() should return only active hierarchies.
        """
    ...
    def test_should_return_inactive_role_hierarchies(
        ...
        """
        inactive() should return only inactive hierarchies.
        """
    ...
    def test_should_filter_by_parent_role(
        ...
        """
        for_parent_role() should filter by parent role.
        """
    ...
    def test_should_filter_by_child_role(
        ...
        """
        for_child_role() should filter by child role.
        """
    ...
    def test_should_return_direct_hierarchies(
        ...
        """
        direct() should return direct hierarchies.
        """
    ...
    def test_should_return_inherited_hierarchies(
        ...
        """
        inherited() should return inherited hierarchies.
        """
    ...
    def test_should_search_role_hierarchies(
        ...
        """
        search() should search hierarchies.
        """
    ...
    def test_should_select_related_objects(
        ...
        """
        with_related() should select related objects.
        """
